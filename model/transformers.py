...
"""
Patch embedding : In this embedding space the already 7 different organs and 8 bcs left and right kidney different classes 


Nex take output from cnn layer 

Linear projection of flattened patches

Next is patch + position embedding
...
class PatchEmbed(nn.Module):
    ...
    embed_dim : int
        ...
        Embedding stays constant across entire network
    Attributes
    ----------
    n_patches : int
...
#output Z
"""
The shaping output patch is P x P and N = HW/(P^2)
"""
